...
sht_data %>%
  ...
  pack_rows("Team",1,9) %>%
  pack_rows("Workspace",10,24) %>%
  pack_rows("Training",25,28) %>%
  pack_rows("Active Rockets",29,33) %>%
  pack_rows("Active Engines",34,38) %>%
  pack_rows("Fuel",39,41) %>%
  pack_rows("Travel",42,46)
