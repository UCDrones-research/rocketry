...
HPR_list <-c("SEB","STAR","APL","ECLIPSE","RPUCIL","RPUCIS","RPUCLA","RA","HSP","SEDS","RPL")
...
sht_data %>%
  ...
  pack_rows("Hazards",17,24) %>%
  pack_rows("Training",25,29) %>%
  pack_rows("Active Rockets",30,34) %>%
  pack_rows("Active Engines",35,37) %>%
  pack_rows("Fuels",38,41) %>%
  pack_rows("Fuel Storage",42,44) %>%
  pack_rows("Travel",45,49)
